...
const year = 2019;
const commands = {};
const commandIndicator = config.commandIndicator || "!";


commands[commandIndicator + '8ball'] = questionObject =>
...
commands[commandIndicator + 'adp'] = nameObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'choose'] = argsObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'next5'] = teamObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'next'] = teamObject =>
  new Promise((resolve, reject) => {
    const team = teamObject.args;
    espn
      .nextGame(team)
...
commands[commandIndicator + 'schedule'] = teamObject =>
  new Promise((resolve, reject) => {
    const team = teamObject.args;
...
commands[commandIndicator + 'roto'] = nameObject =>
  new Promise((resolve, reject) => {
    const name = nameObject.args;
...
commands[commandIndicator + 'teamstats'] = teamStatsObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'teamtargets'] = object =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'help'] = () =>
  new Promise((resolve) => {
    resolve('For command list, see https://github.com/chrisparsons83/RedditFFDiscordBot');
  });

commands[commandIndicator + 'depthchart'] = (depthChartObject) => {
...
commands[commandIndicator + 'poll'] = (pollObject) => {
...
commands[commandIndicator + 'boris'] = (borisObject) => {
...
commands[commandIndicator + 'find'] = findObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'wdis'] = wdisObject =>
  new Promise((resolve, reject) => {
...
commands[commandIndicator + 'prediction'] = () =>
  new Promise((resolve, reject) => {
    reject("Stop trying to make !prediction happen. It's not going to happen.");
  });

commands[commandIndicator + 'shuffle'] = argsObject =>
  new Promise((resolve, reject) => {
    const args = argsObject.args;
    if (!args) {
...
commands[commandIndicator + 'snaps'] = discordObject =>
  new Promise((resolve, reject) => {
